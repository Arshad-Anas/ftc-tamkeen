...
@Autonomous(group = "23925 MainAutonomous", preselectTeleOp = "Auton_redzone")
public class redzone extends LinearOpMode {
    ...
    public void redZone() {
        ...
        long durationForward = 650; // 2 seconds
        long durationTurn = 1750; // 1 second (adjust as needed)
        long durationForwardAfterTurnBackboard = 1250;
